...
`,
        practiceQuestions: [
            ...
            },
            {
                ...
                answer: 'useEffect',
                hint: '`use` + 副作用の英単語',
                explanation: 'useEffectフックは副作用を安全に扱うための仕組みです。レンダリングの後で実行されます。',
            },
            {
                id: 'q3',
                ...
                explanation: 'useEffectの第二引数の配列です。ここに指定した値が変化したときだけuseEffectが再実行されます。',
            },
            {
                id: 'q4',
                ...
                answer: '[]',
                hint: '空の配列を渡します。',
                explanation: '空配列[]を渡すと「依存する値がない＝初回マウント時のみ実行」になります。データの初回取得などに使います。',
            },
            {
                id: 'q5',
...
`,
        practiceQuestions: [
            ...
            },
            {
                ...
                explanation: 'Reactのフォームはe.preventDefault()でページリロードを防ぎます。SPAでは必須のパターンです。',
            },
            {
                id: 'q4',
                ...
                explanation: 'value={state} と指定することで、ReactのstateがinputのUIに反映され「制御された」状態になります。',
            },
            {
                id: 'q5',
                ...
                explanation: 'disabled属性をtrueにするとボタンやinputが無効化されます。disabled={text.length < 3}のようにboolean式を渡せます。',
            },
        ],
        testTask: {
...
`,
        practiceQuestions: [
            ...
            },
            {
                ...
                explanation: 'Context APIを使うと、ツリーの途中を飛び越えて深い階層のコンポーネントに直接データを渡せます。',
            },
            {
                id: 'q3',
                ...
                explanation: 'createContext(デフォルト値)でContextオブジェクトを作成します。このオブジェクトからProviderとuseContextが使えます。',
            },
            {
                id: 'q4',
                ...
                answer: 'Provider',
                hint: '供給者という意味です。',
                explanation: '<ThemeContext.Provider value={...}>で子孫コンポーネントにデータを供給します。value propに渡した値が使えます。',
            },
            {
                id: 'q5',
                ...
                explanation: 'useContext(ThemeContext)のようにContextオブジェクトを渡すと、Providerから供給されたvalue値を取り出せます。',
            },
        ],
        testTask: {
        ...
        practiceQuestions: [
            {
                ...
                explanation: 'useReducerはuseStateの代わりに使えるHookで、複雑な状態遷移ロジックをコンポーネントの外に分離できます。',
            },
            {
                id: 'q2',
            ...
            },
            {
                ...
                explanation: 'dispatch(action)を呼ぶとReducer関数が実行され、新しいstateが計算されます。useStateのsetterに相当します。',
            },
            {
                id: 'q4',
                ...
                explanation: 'action.typeで「何が起きたか」を識別します。例: { type: "INCREMENT" }。switch文でtypeに応じた処理を分岐します。',
            },
            {
                id: 'q5',
